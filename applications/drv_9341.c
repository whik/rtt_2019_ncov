...
{
    /*
    rt_pin_mode(LCD_BL_PIN, GPIO_MODE_OUTPUT_PP);
    rt_pin_mode(LCD_CS_PIN, GPIO_MODE_OUTPUT_PP);
    rt_pin_mode(LCD_RD_PIN, GPIO_MODE_OUTPUT_PP);
    rt_pin_mode(LCD_RS_PIN, GPIO_MODE_OUTPUT_PP);
    rt_pin_mode(LCD_WR_PIN, GPIO_MODE_OUTPUT_PP);

    rt_pin_write(LCD_BL_PIN, 1);
    rt_pin_write(LCD_CS_PIN, 1);
    rt_pin_write(LCD_RD_PIN, 1);
    rt_pin_write(LCD_RS_PIN, 1);
    rt_pin_write(LCD_WR_PIN, 1);
    */
